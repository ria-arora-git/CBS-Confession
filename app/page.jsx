    ...
    <>
      ...
      <div className='h-[100vh] bg-gradient-to-b ' style={{ backgroundImage: "url('/pink.avif')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className='w-screen h-[90vh] flex flex-col items-center bg-gradient-to-b'>
          <header className='w-full lg:h-[15vh] md:h-[15vh] h-[15vh] shadow-zinc-100 shadow-md flex justify-center items-center px-12 gap-1 flex-col'>
          ...
          <div className='w-screen h-[75vh] flex-2 overflow-y-auto lg:w-2/3 p-4 flex flex-col items-center scrollbar-hide mt-4'>
            <div className='md:hidden lg:hidden flex justify-center items-center'>
              <Link href={'/create'} className='border  text-blue-950 bg-white rounded-full text-xl font-semibold flex justify-center items-center mb-2 p-2 py-1'> Add post </Link>
            </div>
